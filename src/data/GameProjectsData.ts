...
export default [
    ...
    `, "#23bd69", true),
    new ProjectData("project-2", "Magicmind", "img/projects/project-2-icon.png", `
    <div class="paragraph">
    ...
    <div class="paragraph">
        ...
        <li>Teachers to students approach Dedicated access for teachers and wellness content creators to create their wellness courses and adapt them to the gamified approach to propose them to the users.</li>
    ...
    `, "#5a78af"),
    new ProjectData("project-3", "09", "img/projects/project-3-icon.png", `
    <div class="paragraph">
    ...
    <div class="paragraph center">
        <img class="phone-screenshot" src="https://fakeimg.pl/534x300/" alt="Solo Mode" />
        <img class="phone-screenshot" src="https://fakeimg.pl/534x300/" alt="Duel Moode" />
        <img class="phone-screenshot" src="https://fakeimg.pl/534x300/" alt="Challange Mode" />
    </div>
    `, "#383838"),
    new ProjectData("project-4", "Kingdom of No One", "img/projects/project-4-icon.png", `
    <div class="paragraph">
    ...
    <div class="paragraph center">
        <img class="pc-screenshot" src="https://fakeimg.pl/534x300/" alt="Queues based battle system" />
        <img class="pc-screenshot" src="https://fakeimg.pl/534x300/" alt="Quests and events tool" />
        <img class="pc-screenshot" src="https://fakeimg.pl/534x300/" alt="Game date (equipement, mercenaries, ennemies, etc) tool" />
    ...
    `, "#e80fb7"),
    new ProjectData("project-5", "Swift Touches", "img/projects/project-5-icon.png", `
    <div class="paragraph">
    ...
    new ProjectData("project-7", "Thoughts", "img/projects/project-5-icon.png", `
    <div class="paragraph">
    ...
    <div class="paragraph">
        <div class="notice">
        You can try this game by developing it from the <a href="https://v3.globalgamejam.org/2015/games/thoughts" target="_blank">Game Jam archive</a>.
        </div>
    </div>
    `, "#e48246"),
    new ProjectData("project-8", "GearVR Playroom", "img/projects/project-5-icon.png", `
    <div class="paragraph">
    ...
    `, "#e48246"),
    new ProjectData("project-9", "Garcito", "img/projects/project-5-icon.png", `
    <div class="paragraph">
    ...
    `, "#e48246"),
    new ProjectData("project-11", "Bugs", "img/projects/project-5-icon.png", `
    <div class="paragraph">
    ...
    `, "#e48246"),
    new ProjectData("project-12", "Illusion", "img/projects/project-5-icon.png", `
    <div class="paragraph">
    ...
    `, "#e48246"),
    new ProjectData("project-13", "Space War", "img/projects/project-5-icon.png", `
    <div class="paragraph">
    This academic project is a classic <strong>Shoot 'em up</strong> for <strong>Samsung smart TV</strong>, developed using the <strong>HTML5/javascript</strong> game framework, <strong>Phaser 2</strong>.
    </div>    
    <div class="paragraph center">
        <iframe class="youtube" src="https://www.youtube.com/embed/dQw4w9WgXcQ" frameborder="0" allowfullscreen></iframe>
    </div>
